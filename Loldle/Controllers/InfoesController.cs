...
namespace Loldle.Controllers
{
    public class InfoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Gender,Type,Race,Region")] Info info)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Gender,Type,Race,Region")] Info info)
        {
            if (id != info.Id)
            {
                return NotFound();
