...
namespace loldle.Controllers
{
    public class QuotesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TextForQuestion,Answer")] Quote quote)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TextForQuestion,Answer")] Quote quote)
        {
            if (id != quote.Id)
            {
                return NotFound();
