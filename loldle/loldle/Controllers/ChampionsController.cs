...
namespace loldle.Controllers
{
    public class ChampionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Gender,Type,Race,Region,Positions,Resource,RangeType")] Champion champion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Gender,Type,Race,Region,Positions,Resource,RangeType")] Champion champion)
        {
            if (id != champion.Id)
            {
                return NotFound();
